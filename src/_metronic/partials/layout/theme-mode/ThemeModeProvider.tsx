...
export const systemMode = ThemeModeComponent.getSystemMode() as
  | "light"
  | "dark";
...
export const themeModeSwitchHelper = (_mode: ThemeModeType) => {
...
export const getThemeModeFromLocalStorage = (lsKey: string): ThemeModeType => {
  if (!localStorage) {
    return "light";
  }
...
export const defaultThemeMode: ThemeModeContextType = {
